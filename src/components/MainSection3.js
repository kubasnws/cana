  ...
  render() {
    ...
    const sideText = (
      <div className={[s.sideText, "sideText"].join(" ")}>
        ...
        <div className={[s.decorationText, "decorationText"].join(" ")}>
          {lettersSplit("news")}
        </div>
      </div>
    );
    ...
    return (
      <Swipe onSwipeDown={this.onSwipeDown} onSwipeUp={this.onSwipeUp}>
        <div className={s.mainContainer}>
          ...
          <img
            className={[s.leftImage, "sec_3_image"].join(" ")}
            src={leftImage && leftImage.url}
            alt=""
          />
          <div className={s.leftSection}>
            <div className={s.content}>
              <div className={[s.buttonWrapper, "buttonBox"].join(" ")}>
                <p>
                  {lang === "en" ? "It is so easy" : "To jest naprawdę proste"}
                </p>
                <DelayLink
                ...
                >
                  <button type="button">
                    {lang === "en" ? "Just find out" : "Przekonaj się"}
                  </button>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(MainSection3)
);
