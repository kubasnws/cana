      ...
      <>
        <Link to={clicable === false ? "/age" : "/"}>
          <div className={s.logo}>
            <div
              className={[s.logoAnimationLines, "logoAnimationLines"].join(" ")}
              style={color === "dark" ? darkLeft : null}
            ></div>
            <div
              className={[s.logoAnimationLines, "logoAnimationLines"].join(" ")}
              style={color === "dark" ? darkRight : null}
            ></div>
            <img
              className={[s.logo, "logo"].join(" ")}
              src={acf && (color === "dark" ? acf.logo_dark.url : acf.logo.url)}
